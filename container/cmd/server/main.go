...
func main() {
	...
	v1.Post("/git/worktrees/batch/sync/check", gitHandler.CheckBatchSyncConflicts)
	...
	v1.Post("/git/worktrees/batch/merge/check", gitHandler.CheckBatchMergeConflicts)
	v1.Get("/git/worktrees/:id/diff", gitHandler.GetWorktreeDiff)
	v1.Post("/git/worktrees/batch/diff", gitHandler.GetBatchWorktreeDiff)
	...
	v1.Post("/git/worktrees/batch/pr", gitHandler.GetBatchPullRequestInfo)
