...
const docTemplate = `{
        ...
        "/v1/sessions/workspace/{workspace}/status": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Number of recent statuses to return (default: all)",
                        "name": "count",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.StatusHistoryResponse"
                        }
                    }
                }
            },
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.StatusUpdateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_handlers.StatusEntry": {
            "type": "object",
            "properties": {
                "branch": {
                    "description": "Git branch at the time of status update",
                    "type": "string"
                },
                "raw_input": {
                    "description": "Raw input data as received",
                    "type": "string"
                },
                "timestamp": {
                ...
                "tool_input": {
                    "description": "Tool input data from Claude",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
        ...
        "internal_handlers.StatusHistoryResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
                ...
                "statuses": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_handlers.StatusEntry"
                    }
                },
                "workspace": {
                    "type": "string"
        ...
        "internal_handlers.StatusUpdateRequest": {
            "type": "object",
            "properties": {
                "branch": {
                    "type": "string"
