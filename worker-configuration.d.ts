/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a46b38ff317d7a6d55aba7de6b5cbadb)
// Runtime types generated with workerd@1.20251125.0 2025-07-05 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "CatnipContainer" | "SessionStore" | "CodespaceStore" | "KeepAliveContainer" | "KeepAliveCoordinator";
	}
	interface Env {
		GITHUB_APP_ID: "1594287";
		ENVIRONMENT: "qa" | "production";
		APPLE_APP_SPECIFIC_PASSWORD: string;
		MACOS_NOTARY_PROFILE_NAME: string;
		GORELEASER_KEY: string;
		APPLE_ISSUER_ID: string;
		APPLE_KEY_ID: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		APPLE_SIGN_PASSWORD: string;
		APPLE_PRIVATE_KEY: string;
		APPLE_SIGN_P12: string;
		CATNIP_ENCRYPTION_KEY: string;
		KEEPALIVE_CONTAINER: DurableObjectNamespace<import("./worker/index").KeepAliveContainer>;
		KEEPALIVE_COORDINATOR: DurableObjectNamespace<import("./worker/index").KeepAliveCoordinator>;
		SESSIONS: DurableObjectNamespace<import("./worker/index").SessionStore>;
		CODESPACE_STORE: DurableObjectNamespace<import("./worker/index").CodespaceStore>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_APP_ID" | "ENVIRONMENT" | "APPLE_APP_SPECIFIC_PASSWORD" | "MACOS_NOTARY_PROFILE_NAME" | "GORELEASER_KEY" | "APPLE_ISSUER_ID" | "APPLE_KEY_ID" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "APPLE_SIGN_PASSWORD" | "APPLE_PRIVATE_KEY" | "APPLE_SIGN_P12" | "CATNIP_ENCRYPTION_KEY">> {}
}
